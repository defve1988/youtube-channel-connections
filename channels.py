...
channel_list.add_channels(channels, "Knowledge")
...
channel_list.add_channels(channels, "Films")
...
channel_list.add_channels(channels, "Animes")
...
channel_list.add_channels(channels, "Games")
...
channel_list.add_channels(channels, "Life")
...
channels = {
    ...
    "stone记":"https://www.youtube.com/channel/UCghLs6s95LrBWOdlZUCH4qw"}
channel_list.add_channels(channels, "Ainti-CCP")
...
channels = {
    ...
    "波士顿自干五-圆脸传媒":"https://www.youtube.com/channel/UCnyPxKrdrXDjlBBucRAIuuA",}
channel_list.add_channels(channels, "CCP")
...
channel_list.add_channels(channels, "Coding")
